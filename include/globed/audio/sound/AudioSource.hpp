...
public:
    ...
    /// If a stream is simply inactive (player not talking), this should generally NOT return false, unless it's ok to cleanup the stream fully.
    /// If this returns false, the sound is completely removed from the manager.
