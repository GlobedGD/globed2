...
Result<DisplayDataRefreshed> DisplayDataRefreshed::decode(qn::ByteReader& reader) {
    int playerId = READER_UNWRAP(reader.readI32());
...
Result<FollowAbsoluteEvent> FollowAbsoluteEvent::decode(qn::ByteReader& reader) {
