...
#define KCASEN(k, n)                                                                                                   \
    ...
    switch (key) {
        ...
        KCASEN(NumPad0, "Num 0");
        KCASEN(NumPad1, "Num 1");
        KCASEN(NumPad2, "Num 2");
        KCASEN(NumPad3, "Num 3");
        KCASEN(NumPad4, "Num 4");
        KCASEN(NumPad5, "Num 5");
        KCASEN(NumPad6, "Num 6");
        KCASEN(NumPad7, "Num 7");
        KCASEN(NumPad8, "Num 8");
        KCASEN(NumPad9, "Num 9");
        KCASEN(NumPadDecimal, "Num .");
        KCASEN(NumPadDivide, "Num /");
        KCASEN(NumPadMultiply, "Num *");
        KCASEN(NumPadSubtract, "Num -");
        KCASEN(NumPadAdd, "Num +");
        KCASEN(NumPadEnter, "Num Enter");
        KCASEN(NumPadEqual, "Num =");
        ...
        KCASE(Home);
        KCASE(End);
        KCASEN(PageUp, "Page Up");
        KCASEN(PageDown, "Page Down");
        KCASEN(CapsLock, "Caps Lock");
        KCASEN(ScrollLock, "Scroll Lock");
        KCASEN(NumLock, "Num Lock");
        KCASEN(PrintScreen, "Print Screen");
        KCASEN(Pause, "Pause");
...
{
    return formatKey(convertCocosKey(key));
}
