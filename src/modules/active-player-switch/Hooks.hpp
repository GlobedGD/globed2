...
struct GLOBED_MODIFY_ATTR APSPlayLayer : geode::Modify<APSPlayLayer, PlayLayer> {
    ...
    {
        GLOBED_CLAIM_HOOKS(APSModule::get(), self, "PlayLayer::init", "PlayLayer::destroyPlayer");
    }
...
struct GLOBED_MODIFY_ATTR APSGJBGL : geode::Modify<APSGJBGL, GJBaseGameLayer> {
    static void onModify(auto &self)
    {
        GLOBED_CLAIM_HOOKS(APSModule::get(), self, "GJBaseGameLayer::handleButton", "GJBaseGameLayer::update");
    }
    ...
    $override void handleButton(bool a, int b, bool c);
...
struct GLOBED_MODIFY_ATTR APSPauseLayer : geode::Modify<APSPauseLayer, PauseLayer> {
    static void onModify(auto &self)
    {
        GLOBED_CLAIM_HOOKS(APSModule::get(), self, "PauseLayer::customSetup");
    }
