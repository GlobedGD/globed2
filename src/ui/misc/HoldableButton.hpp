...
public:
    static HoldableButton *create(cocos2d::CCSprite *sprite, std23::move_only_function<void(HoldableButton *)> onClick,
                                  std23::move_only_function<void(HoldableButton *)> onHold);

    static HoldableButton *create(const char *spriteName, std23::move_only_function<void(HoldableButton *)> onClick,
                                  std23::move_only_function<void(HoldableButton *)> onHold)
    {
        return create(cocos2d::CCSprite::create(spriteName), std::move(onClick), std::move(onHold));
    }

    static HoldableButton *createWithSpriteFrameName(const char *spriteName,
                                                     std23::move_only_function<void(HoldableButton *)> onClick,
                                                     std23::move_only_function<void(HoldableButton *)> onHold)
    {
        return create(cocos2d::CCSprite::createWithSpriteFrameName(spriteName), std::move(onClick), std::move(onHold));
    }
...
private:
    ...
    bool init(cocos2d::CCSprite *sprite, std23::move_only_function<void(HoldableButton *)> onClick,
              std23::move_only_function<void(HoldableButton *)> onHold);
