...
bool FeaturedPopup::setup()
{
    ...
    CCMenu *blCornerMenu = Build<CCMenu>::create().pos(20.f, 20.f).zOrder(5).parent(m_mainLayer);

    auto infoBtn =
        Build<CCSprite>::createSpriteName("GJ_infoIcon_001.png")
            .intoMenuItem(+[] {
                globed::alert("Featured Guide",
    ...
    auto viewAllMenu = Build<CCMenu>::create().parent(m_mainLayer).pos(this->fromBottom(40.f));
    ...
    auto sequence = CCSequence::create(
        CCEaseElasticOut::create(CCMoveTo::create(0.5f, {winSize.width * 0.5f, winSize.height / 2}), 0.85), nullptr);
