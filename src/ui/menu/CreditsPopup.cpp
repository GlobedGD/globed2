...
static const std::vector<CreditsCategory>& defaultData() {
    static const std::vector<CreditsCategory> g_defaultData {
        ...
        CreditsCategory { "Admins", {
            ...
            CreditsUser { 12016320, 40684062, "500skills", "500skills", 344, 44, 86, -1 },
            CreditsUser { 25517837, 153455117, "arxynr", "arxynr", 132, 52, 12, 41 },
            CreditsUser { 26075508, 234267954, "NotPerfect5625", "NotPerfect5625", 483, 106, 73, -1 },
        }},
        CreditsCategory { "Moderators", {
            ...
            CreditsUser { 6442871, 31833361, "TheKiroshi", "TheKiroshi", 1, 8, 11, 10 },
            CreditsUser { 6879727, 38395219, "Szyly", "Szyly", 1, 12, 2, 12 },
            CreditsUser { 7731541, 55662104, "EpicLooch", "EpicLooch", 459, 12, 8, 44 },
            CreditsUser { 8262191, 61991331, "Jiflol", "Jiflol", 343, 44, 98, -1 },
            CreditsUser { 11764819, 118973941, "Laayte", "Laayte", 123, 15, 13, -1 },
            CreditsUser { 11826816, 119571419, "hauxz", "hauxz", 442, 9, 3, 3 },
            CreditsUser { 13678537, 132787232, "Delivel", "Delivel", 238, 12, 8, 51 },
            CreditsUser { 13893429, 97492030, "Xepheron", "Xepheron", 296, 6, 10, 42 },
            CreditsUser { 16045685, 158535626, "Lamnhiem", "Lamnhiem", 1, 1, 3, 12 },
            CreditsUser { 18298730, 169274462, "YESEvoi", "YESEvoi", 140, 3, 2, 12 },
            CreditsUser { 18574519, 168574224, "JollySpider", "JollySpider", 385, 98, 43, 100 },
            CreditsUser { 19444165, 176350387, "TinTinzzz", "TinTinzzz", 267, 18, 41, -1 },
            CreditsUser { 21143615, 190847322, "Xeronin", "Xeronin", 173, 13, 4, 12 },
            CreditsUser { 21975575, 94919182, "maurry", "maurry", 394, 41, 12, 12 },
            CreditsUser { 41406231, 347747261, "NotSharkyy", "NotSharkyy", 37, 3, 12, 12 },
            CreditsUser { 42063419, 353632704, "theblus", "theblus", 459, 12, 12, -1 },
        }},
        CreditsCategory { "Trial Moderators", {
            CreditsUser { 2258711, 10153999, "rav3nnn", "rav3nnn", 60, 8, 15, 1 },
            CreditsUser { 5742017, 17842450, "RealHound", "RealHound", 110, 2, 12, 12 },
            CreditsUser { 17216259, 128538143, "ZannyDaPrince", "ZannyDaPrince", 463, 62, 12, 12 },
        }},
        CreditsCategory { "Contributors", {
            CreditsUser { 1621348, 8463710, "availax", "availax", 1, 12, 255, 12 },
            ...
            CreditsUser { 7214334, 42454266, "LimeGradient", "LimeGradient", 46, 98, 3, 12 },
            CreditsUser { 4569963, 15447500, "ItzKiba", "ItzKiba", 110, 6, 10, 42 },
        }},
        CreditsCategory { "Special thanks", {
            ...
            CreditsUser { 11535118, 116938760, "alk1m123", "alk1m123", 102, 12, 12, -1 },
            CreditsUser { 5568872, 19127913, "mat4", "mat4", 453, 12, 19, 12 },
            CreditsUser { 1139015, 7834088, "Alphalaneous", "Alphalaneous", 452, 0, 105, -1 },
