...
static const std::vector<CreditsCategory>& defaultData() {
    static const std::vector<CreditsCategory> g_defaultData {
        ...
        CreditsCategory { "Admins", {
            ...
            CreditsUser { 26075508, 234267954, "NotPerfect5625", "NotPerfect5625", 483, 106, 72, -1 },
        }},
        CreditsCategory { "Moderators", {
            ...
            CreditsUser { 5722734, 19663714, "charlesmot", "charlesmot", 238, 3, 70, 70 },
            CreditsUser { 5906108, 20465032, "Jett James", "Jett James", 39, 42, 3, 83 },
            CreditsUser { 6442871, 31833361, "TheKiroshi", "TheKiroshi", 1, 8, 11, 63 },
            CreditsUser { 6879727, 38395219, "Szyly", "Szyly", 296, 12, 2, 12 },
            ...
            CreditsUser { 9099846, 83020987, "16lord", "16lord", 37, 12, 23, 12 },
            CreditsUser { 9358208, 85434605, "Silvow", "Silvow", 140, 3, 11, -1 },
            CreditsUser { 12016320, 40684062, "500skills", "500skills", 344, 44, 86, -1 },
            CreditsUser { 13488213, 119652180, "Starr44", "Starr44", 111, 52, 12, 98 },
            ...
            CreditsUser { 15347333, 126748277, "DuckNgl", "DuckNgl", 291, 71, 12, 12 },
            CreditsUser { 16045685, 158535626, "Lamnhiem", "Lamnhiem", 67, 12, 51, 12 },
            CreditsUser { 18226543, 160504868, "capeling", "capeling", 30, 9, 12, -1 },
            ...
            CreditsUser { 24387180, 216616532, "Goalers", "Goalers", 183, 94, 73, 12 },
            CreditsUser { 26619661, 238097046, "tTonk", "tTonk", 31, 106, 12, -1 },
        }},
        CreditsCategory { "Trial Moderators", {
            CreditsUser { 11826816, 119571419, "hauxz", "hauxz", 11, 9, 3, 3 },
            CreditsUser { 17405473, 165364574, "razGMD", "razGMD", 437, 12, 8, 19 },
        }},
        CreditsCategory { "Contributors", {
            ...
            CreditsUser { 20284359, 179839933, "TechStudent10", "TechStudent10", 79, 10, 14, 14 },
            ...
            CreditsUser { 25397826, 227796112, "Uproxide", "Uproxide", 1, 2, 3, -1 },
        ...
        CreditsCategory { "Special thanks", {
            ...
            CreditsUser { 5568872, 19127913, "mat4", "mat4", 406, 12, 19, 12 },
            CreditsUser { 1139015, 7834088, "Alphalaneous", "Alphalaneous", 452, 20, 105, 83 },
