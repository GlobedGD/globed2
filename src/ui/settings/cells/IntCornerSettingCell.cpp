...
void IntCornerSettingCell::setup()
{
    ...
    m_innerSquare = Build(CCLayerColor::create({89, 172, 255, 255}, 12.f, 12.f)).ignoreAnchorPointForPos(false);

    auto container =
        Build<CCNode>::create().anchorPoint(0.5f, 0.5f).contentSize(32.f, 32.f).child(m_innerSquare).collect();
