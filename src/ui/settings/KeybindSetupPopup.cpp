...
bool KeybindSetupPopup::setup(enumKeyCodes key)
{
    ...
    auto applyButton =
        Build<ButtonSprite>::create("Apply", "bigFont.fnt", "GJ_button_01.png", 0.75f)
            .intoMenuItem([this](auto) {
                ...
                if (km.isKeyUsed(m_key)) {
                    Notification::create("This key is already used by another action", NotificationIcon::Error, 1.0f)
                        ->show();
                    return;
                }
