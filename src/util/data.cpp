...
namespace util::data {
    ...
    int16_t byteswapI16(int16_t value) {
        return std::bit_cast<int16_t>(byteswapU16(std::bit_cast<uint16_t>(value)));
    }

    int32_t byteswapI32(int32_t value) {
        return std::bit_cast<int32_t>(byteswapU32(std::bit_cast<uint32_t>(value)));
    }

    int64_t byteswapI64(int64_t value) {
        return std::bit_cast<int64_t>(byteswapU64(std::bit_cast<uint64_t>(value)));
    }
    ...
    double byteswapF64(double value) {
        return std::bit_cast<double>(byteswapU64(std::bit_cast<uint64_t>(value)));
    }
};
