...
REQUIRED_GEODE_VERSION = "v5.8.0"
XTLS_VERSION = "e29f88a"
QUNET_VERSION = "a8e2f93"
...
def make_constants_codegen(state: State) -> str:
    ...
    sentry_url = os.environ.get("GLOBED_SENTRY_URL", "")
    sentry_key = os.environ.get("GLOBED_SENTRY_KEY", "")
    ...
    constants = {
        ...
        "sentry-env": "release" if gc.release else "development",
