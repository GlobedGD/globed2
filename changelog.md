...
* New `globed::api::room` namespace with room-related functions
...
Major changes:
* <cj>Quick Chat</c> was added, allowing players to send <cp>emotes</c> during gameplay!
...
* Room owners can now <cy>kick and ban</c> people from their rooms
...
* Certain <cy>rarely used</c> settings were removed, however they might get added in the future: DNS over HTTPS, Server relays
...
* Add DNS over HTTPS setting, to help bypass potential DNS-based blocks
